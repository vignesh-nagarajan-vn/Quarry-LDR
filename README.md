...
| --- | --- | --- |
| [`main`](https://github.com/vignesh-nagarajan-vn/Quarry-LDR) | [v1.0.1](https://github.com/vignesh-nagarajan-vn/Quarry-LDR/releases/tag/v1.0.1) | The v1 local-first line: your GPU plans, writes, and verifies by default at $0.00 in API spend, with `assisted` and `premium` as paid engine tiers and a branded PDF beside every report |
...
- [pdf-reports/](pdf-reports/): four sample PDF reports straight from the pipeline, covering all three engines ($0.00 local through $2.55 premium), with the numbers behind each.
